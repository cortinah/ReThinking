...
ggplot(results, aes(x=length, y=prob)) +geom_line(alpha=0.8, color='red2') +
  ...
  scale_y_continuous(breaks=seq(0.4,1,.1),lim=c(0.4,1)) +
    labs(y='Probability of Repeating Song', x="Length of Santa's Playlist",
...
<img src="/post/2018-12-22-the-riddler-santa-needs-some-help-with-math_files/santaplaylist.png" alt="" width="800px"/>
