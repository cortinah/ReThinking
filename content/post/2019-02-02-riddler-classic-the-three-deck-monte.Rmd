...
`r blogdown::shortcode("tweet", "1091345144543133702")`
...
```{r game, fig.height=7, fig.width=7, message=FALSE, warning=FALSE, results='asis'}
library(ggplot2)
...
formula to compute the standard error of those means.  For example if your opponent plays optimally you will only with with 29.7% probability +/- 0.1%.  So don't play this game...

```{r game2, fig.height=7, fig.width=7, message=FALSE, warning=FALSE, echo=F}
library(knitr)
library(kableExtra)
