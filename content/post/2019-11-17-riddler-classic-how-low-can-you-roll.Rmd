...
`r blogdown::shortcode("tweet", "1195330849224441857")`
...
Below is the calculation of the average score and its standard error. I use the standard devation divided by the square root of the number of observations to get standard deviation.
...
And the answer is... 0.4736 with a standard deviation of 0.0002141.  A 95% confidence interval for the average score is (0.4731, 0.4740). It's not obvious (at least to me) from the construction of the problem that the average would be near 0.47, or even below 0.5. 
