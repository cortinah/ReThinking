...
The Gold set requires 300 unique cards and therefore on average about 187 10-card packs. Since it's more computationally intensive, I reduce the number of simulations to 1,500 which results in a standard error of the mean of about one.
