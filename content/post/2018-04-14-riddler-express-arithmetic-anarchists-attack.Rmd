...
@Cardlinger commented on the fact that the y axis seems to start at a negative value.  This allows for "zeros" on the chart to be clearly distinguished. Otherwise, with 99 bars, the small gaps between gaps caused by zeros would be difficult to identify.

{{< tweet 984798381154406401 >}}
