...
`r blogdown::shortcode("tweet", "1003654868807110657")`
...
![Ollie's Shout Out](/post/2018-08-05-riddler-classic-the-perfect-doodle-puzzle_files/doodle.png){width=60%}
...
`r blogdown::shortcode("tweet", "1025449775804637185")`