...
We start the EDA by looking at the range of daily highs/lows by month. First we look at the full 142 years, and below we break it down into the 1876-2000 and 2000-2018 periods. The overall seasonality looks as expected, but we can see that the winters in recent years have become less cold, and the summers warmer. While winter lows in the -25 to -20 range occurred in the earlier period, more recent winter lows are near -15. Furthermore, the daily high curve has shifted higher and 30-35 degree highs are more common.
...
If you got this far, thank you for reading and please don't hesitate to send me your comments or suggestions. While this analysis pertains to only a single location, the conclusions I draw from this are unfortunatealy rather dispiriting, and reinforce the urgent need to act against catastrophic climate change.